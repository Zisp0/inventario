...
@section('title')
    <div class="text-center p-2">
        ...
        <h1 class="text-3xl mt-8 md:mt-0">CREAR PEDIDO PARA USO VETERINARIO</h1>
    </div>
@endsection
@section('content')
    <form method="POST" action="/pedidos/crear" id="pedidoForm" class="flex flex-col items-center mt-4 gap-4">
        @csrf
        ...
        @else
            <button type="submit" class="submit h-10 w-32 rounded-lg">Crear pedido</button>
        @endif
    </form>
@endsection
